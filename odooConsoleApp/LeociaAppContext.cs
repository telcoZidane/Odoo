...
public partial class LeociaAppContext : DbContext
{
    public LeociaAppContext()
    {
    }
    private const string connectionString = "Server=DESKTOP-PITS4MM;Database=LEOCIA1;Trusted_Connection=True;TrustServerCertificate=True;";
    public LeociaAppContext(DbContextOptions<LeociaAppContext> options)
        : base(options)
    {
    }
